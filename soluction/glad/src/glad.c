/*
    ...
    GLSC2, OpenGL, OpenGL ES loader generated by glad 0.1.36 on Tue Apr  1 14:16:18 2025.

    Language/Generator: C/C++
    Specification: gl
    APIs: gl=2.1, gles1=1.0, gles2=3.2, glsc2=2.0
